    ...
    <div class="tabs-content" data-tabs-content="frm-page-tabs">
        <div class="tabs-panel is-active" id="tab-content">
            ...
            <div>
                ...
                <input name="slug" id="slug" type="text" pattern="^[a-z0-9_-]+$" maxlength="250" aria-describedby="slug_txt">
            ...
            <div>
                ...
                <textarea rows="3" name="short" id="short" pattern="^(.*\S+.*)$" aria-describedby="short_txt"></textarea>
            ...
            <div class="inline-block">
                ...
                <input type="text" name="restricted_password" id="restricted_password" aria-describedby="restricted_password_txt">
        ...
        <div class="tabs-panel" id="tab-meta">
            ...
            <div>
                ...
                <div class="meta-description-input-wrap">
                    <textarea rows="3" name="meta_description" id="meta_description" pattern="^(.*\S+.*)$"></textarea>
                </div>
            </div>
            <div>
        ...
        <div class="btn-submit">
            <?php echo form_hidden('_action', 'edit'); ?>
