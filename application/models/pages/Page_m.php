...
class Page_m extends MY_Model {
	 ...
	 * @return array|bool
	 */
	private function _filter_data( array $input = [], $action = NULL, $current_id = 0 ) {
		...
		$_array = [
			...
			'languages_id'     => (int) lang_item( $input['languages'] )->languages_id,
		...
		// check slug
		$_array['slug'] = $this->_sibling_slug( $_array['slug'], $_array['pid'], $current_id );
