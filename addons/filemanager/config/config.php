...
// uploads uri
$upload_uri = rtrim(dirname(dirname(dirname($_SERVER['SCRIPT_NAME']))), '/') . '/uploads/';
$thumbs_uri = rtrim(dirname(dirname(dirname($_SERVER['SCRIPT_NAME']))), '/') . '/thumbs/';
